...
- พาทัว repo สำหรับเพื่อนใหม่: [docs/onboarding/repo-tour.md](docs/onboarding/repo-tour.md)
- คู่มือทำ UI-only สำหรับ Onboarding และ Login: [docs/onboarding/ui-onboarding-login-guide.md](docs/onboarding/ui-onboarding-login-guide.md)
